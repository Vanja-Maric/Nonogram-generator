...
public class BWKeyNumbersGetter {
  int[][] pictureGrid;

  public BWKeyNumbersGetter(int[][] pictureGrid) {
  ...
  public ArrayList<ArrayList<Integer>> getRowNumbers() {
    ...
    // Count 1 in Rows is 2D ArrayList and not 2D Array because I do not know how
    // many groups of 1s are in every row
  ...
  public ArrayList<ArrayList<Integer>> getColumnNumbers() {
    ...
    // Count 1 in Columns is 2D ArrayList and not 2D Array because we do not know
    // how many groups of 1s are in every column
